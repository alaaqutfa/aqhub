...
class SeedEuVatRatesCommand extends Command
{
    ...
    {
        $this->info('Seeding EU VAT rates...');
        $this->newLine();
        ...
        $this->info("Tax 'EU VAT' created/found with ID: {$tax->id}");
        ...
        $this->newLine();
        $this->info("EU VAT rules: {$created} created, {$updated} updated");
        ...
        $this->line('  1. Go to Admin → Ecommerce → Taxes');
        $this->line('  2. Edit "EU VAT" to verify rates');
        $this->line('  3. Assign "EU VAT" tax to your products');
        $this->line('  4. Customers will be charged VAT based on their shipping country');
