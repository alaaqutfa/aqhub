    ...
    window.EcommerceUpSaleCrossSale = {
        ...
        initBlockLazyLoading: function () {
            ...
            $(document).find('[data-bb-toggle="block-lazy-loading"]').each(function () {
                ...
                // Only handle up-sale and cross-sale, skip other lazy loading elements (like related products)
                if (!url.includes('up-sale-products') && !url.includes('cross-sale-products')) {
                    return
                }
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        // Determine if this is up-sale or cross-sale
                        if (url.includes('up-sale-products')) {
